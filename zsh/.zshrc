...
alias ch='helix ~/.config/hypr/hyprland.conf ~/.config/waybar/config.jsonc ~/.config/waybar/style.css'
alias cn='helix ~/.config/niri/config.kdl ~/.config/waybar/config.jsonc ~/.config/waybar/style.css'
